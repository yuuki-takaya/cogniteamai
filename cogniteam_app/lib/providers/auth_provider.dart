...
// Provider for InsightService instance
final insightServiceProvider = Provider<InsightService>((ref) {
  final apiService = ref.watch(apiServiceProvider).value;
  if (apiService == null) {
    throw StateError("ApiService not yet available for InsightService. Ensure ApiServiceProvider is loaded.");
  }
  return InsightService(apiService);
});
