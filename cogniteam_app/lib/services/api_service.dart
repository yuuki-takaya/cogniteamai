...
import 'package:firebase_auth/firebase_auth.dart' as fb_auth; // For getting ID token
      ...
      InterceptorsWrapper(
        onRequest: (options, handler) async {
          ...
          if (firebaseUser != null) {
            try {
              final String idToken = await firebaseUser.getIdToken(true); // Force refresh if needed
            ...
            print('No Firebase user currently signed in. Authorization header will not be set.');
          }
        ...
        onError: (DioException e, handler) {
          ...
          print('Error: ${e.statusCode} ${e.requestOptions.path}');
